  ...
  return (
    <div className="max-w-[90vw]">
      ...
      {/* <p className="leading-6">
        ...
        In terms of physical health, going to the gym will help you manage your
        weight, gain muscle, improve your cardiovascular health, improve your
        strength and sports performance, boost your energy levels, increase your
        lifespan, and so much more. <br className="h-6" /> In terms of mental
...
export default StartExercising;
