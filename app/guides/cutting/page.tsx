...
const Bulking = () => {
  return (
    <div className="max-w-[90vw]">
      <h1 className="heading">How to start Cutting</h1>
      <h1 className="mt-0.5 text-gray-500">Written by: Sadie Ostrowicki</h1>
      ...
      <div className="text-xl font-medium">
        ...
        <ScrollLink
          className="mt-0.5 header-link underline block"
          to="when-to-stop-cutting"
          smooth={true}>
          When to Stop Cutting
        </ScrollLink>
      </div>
      <h1 className="text-2xl font-semibold mt-4" id="what-is-cutting">
        What is Cutting
      </h1>
      <p className="leading-6">
        Cutting refers to a phase in fitness where someone aims to reduce their
        body fat while preserving or even gaining muscle mass. The goal of
        cutting is to look more lean and defined. Cutting often follows a
        “bulking” phase, which is when a person focuses on gaining mass and
        strength.
      </p>
      <h1
        className="text-2xl font-semibold mt-4 mb-2"
        id="how-to-start-cutting">
        How to Start Cutting
      </h1>
      <p className="leading-6">
        <span className="text-lg font-semibold">Step 1: </span> Set Clear Goals{" "}
        <br />
        Setting goals is important for maintaining motivation, and assessing
        your progress. You should be able to specifically define your specific
        fitness goals(think SMART goals), such as the desired body fat
        percentage, weight loss targets, or physique you want to achieve.
        Setting a goal is also important to know when to stop, as being in a
        calorie deficit for too long can result in losing more muscle than you
        want and can slow your metabolism. <br />
        <br />
        <span className="text-lg font-semibold">Step 2: </span> Calculate Your
        Maintenance Calories <br />
        To lose weight, you need to be in a calorie deficit, meaning you burn
        more calories than you eat. To find your personal deficit, you must
        ...
        <br />
        <br />
        <span className="text-lg font-semibold">Step 4: </span>
        Prioritize Nutrient-Dense and High-Protein Foods <br />
        ...
        tofu, and legumes. If you are relying on plant-based protein, make sure
        you diversify your protein sources, as many vegetarian proteins are
        incomplete on their own.
        <br />
        <br />
        <span className="text-lg font-semibold">Step 5: </span> Combine Strength
      ...
      <p className="mb-2">
        ...
        gallo and top with more veggies
      </p>
      <p className="mb-2">
        Better Tomato Soup (Leaf): Ask for a scoop of tofu butter masala, top
        with tomato soup and garnish with cilantro
      </p>
      <p className="mb-2">
        Grilled Chicken (Smoke House) and Salad: Ask for just the grilled
        chicken, and then head over to the salad bar to make a leafy salad
      </p>
      <p className="mb-2">
        Mexican Breakfast (Ave. A and La Mesa): Get just scrambled eggs from
        Ave. A, and then head over to La Mesa to get veggies, black beans,
        cheese and pico de gallo
      </p>
      <p className="mb-2">
        Chicken Soup (La Mesa): Ask for just the shredded chicken, and then head
        over to the soup station to add noodles, pho broth and whatever add-ons
        you like
      </p>
      <p className="mb-2">
      ...
      <p className="leading-6">
        ...
        your body may adapt to the calorie deficit by slowing down your
        metabolism. This can make it more challenging to continue losing fat and
        could lead to fat loss plateaus. It can also be challenging to sustain
        both mentally, leading to binge eating episodes, as well as an increased
        risk of regaining lost weight when returning to regular eating habits.
        If you are afraid your eating habits have become disordered, please talk
        to a trusted adult and/or a mental health expert.
      </p>
    </div>
  );
};
